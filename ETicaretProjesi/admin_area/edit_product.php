...
<div class="row"><!-- row Starts -->
    <div class="col-lg-12"><!-- col-lg-12 Starts -->
        <ol class="breadcrumb"><!-- breadcrumb Starts -->
            <li class="active">
                <i class="fa fa-dashboard"> </i> Kontrol Paneli / Ürün Düzenle
            </li>
        </ol><!-- breadcrumb Ends -->
    </div><!-- col-lg-12 Ends -->
</div><!-- row Ends -->
        ...
        <div class="panel panel-default"><!-- panel panel-default Starts -->
            <div class="panel-heading"><!-- panel-heading Starts -->
                <h3 class="panel-title">
                    <i class="fa fa-money fa-fw"></i> Ürün Düzenle
                </h3>
            </div><!-- panel-heading Ends -->
            <div class="panel-body"><!-- panel-body Starts -->
                <form class="form-horizontal" method="post" enctype="multipart/form-data"><!-- form-horizontal Starts -->
                    <div class="form-group" ><!-- form-group Starts -->
                        <label class="col-md-3 control-label" > Ürün Başılığı </label>
                        <div class="col-md-6" >
                    ...
                    <div class="form-group" ><!-- form-group Starts -->
                        ...
                        <div class="col-md-6" >
                            ...
                            <br><img src="product_images/<?php echo $p_image1; ?>" width="80" height="80" >
                        </div>
                    </div><!-- form-group Ends -->
                    <div class="form-group" ><!-- form-group Starts -->
                        ...
                        <div class="col-md-6" >
                            ...
                            <br><img src="product_images/<?php echo $p_image2; ?>" width="80" height="80" >
                        </div>
                    </div><!-- form-group Ends -->
                    <div class="form-group" ><!-- form-group Starts -->
                        ...
                        <div class="col-md-6" >
                            ...
                            <br><img src="product_images/<?php echo $p_image3; ?>" width="80" height="80" >
                        </div>
                    </div><!-- form-group Ends -->
                    <div class="form-group" ><!-- form-group Starts -->
                    ...
                    <div class="form-group" ><!-- form-group Starts -->
                        ...
                        <div class="col-md-6" >
                            <input type="submit" name="update" value="ÜRÜN GÜNCELLE" class="btn btn-primary form-control" >
                        </div>
                    </div><!-- form-group Ends -->
...
<?php
    if(isset($_POST['update'])){
        ...
        if($run_product){
            echo "<script> alert('Ürün güncelleme başarılı') </script>";
